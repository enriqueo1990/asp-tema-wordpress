...
?>
<a class="asp-articulo-tarjeta<?php echo $asp_img ? '' : ' asp-articulo-tarjeta--sin-foto'; ?>" href="<?php echo esc_url( get_permalink( $asp_id ) ); ?>">
	...
	<span class="asp-articulo-tarjeta__texto">
		...
		<?php if ( $asp_autor['nombre'] ) : ?>
			<span class="asp-articulo-tarjeta__meta"><?php echo esc_html( $asp_autor['nombre'] ); ?></span>
		<?php endif; ?>
	</span>
</a>
